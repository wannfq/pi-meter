...
- Shows Claude as awaiting-interface support while a supported Claude allowance
  API remains unavailable.
- Keeps OpenCode Go as `awaiting-interface` until a supported OpenCode Go
  allowance API exists.
